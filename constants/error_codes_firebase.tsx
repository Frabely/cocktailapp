export const WRONG_PASSWORD = {code: 'auth/wrong-password', message: 'Wrong password'}
export const USER_NOT_FOUND = {code: 'auth/user-not-found', message: 'User not found'}
export const TOO_MANY_REQUESTS = {code: 'auth/too-many-requests', message: 'Too many requests. Try again.'}
