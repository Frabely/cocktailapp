...
export const WEAK_PASSWORD: ErrorCodesType = {code: 'auth/weak-password', message: {ENG: 'Weak password. Password should be at least 6 characters long.', GER: 'Schaches Passwort. Das Passwort sollte mindestens 6 Zeichen lang sein.'}}
